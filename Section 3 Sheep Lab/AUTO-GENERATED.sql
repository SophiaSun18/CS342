USE [master]
GO
/****** Object:  Database [sheep]    Script Date: 2/14/2023 4:41:27 PM ******/
...
USE [sheep]
GO
/****** Object:  Schema [ActiveHerd]    Script Date: 2/14/2023 4:41:27 PM ******/
CREATE SCHEMA [ActiveHerd]
GO
/****** Object:  Table [ActiveHerd].[breed]    Script Date: 2/14/2023 4:41:27 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [ActiveHerd].[breed](
 ...
 CONSTRAINT [pk_Bcat] PRIMARY KEY CLUSTERED 
(
	[BreedCategory] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [ActiveHerd].[injectionList]    Script Date: 2/14/2023 4:41:27 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [ActiveHerd].[injectionList](
	...
	[injectionDescription] [varchar](50) NULL,
...
GO
/****** Object:  Table [ActiveHerd].[sheep]    Script Date: 2/14/2023 4:41:27 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [ActiveHerd].[sheepShots]    Script Date: 2/14/2023 4:41:27 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [ActiveHerd].[sheepShots](
	...
	[InjectionType] [varchar](30) NULL,
 CONSTRAINT [pk_ID, pk_shotType, pk_shotDate] PRIMARY KEY CLUSTERED 
(
	[IdNumber] ASC,
	[ShotType] ASC,
	[ShotDate] ASC
...
GO
/****** Object:  Table [ActiveHerd].[shotList]    Script Date: 2/14/2023 4:41:27 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [ActiveHerd].[shotList](
	[ShotType] [varchar](20) NOT NULL,
	[shotDescription] [varchar](50) NULL,
